...
GitHub Actions 检查和本地 Vale 检查并不是替代关系，而是互补关系。
...
* 理解文档质量检查如何接入 CI/CD 流程；
* 能够解释 GitHub Actions 工作流的基本结构；
* 能够把文档检查从本地操作扩展到自动化流程；
* 能够从提交、检查、反馈、修复的角度理解文档工程化；
* 能够用表格、流程图和示例配置降低读者理解成本。
