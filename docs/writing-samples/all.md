...
<div class="sample-directory-page">
  <p class="sample-directory-intro">以下页面按项目排列。</p>

  <section class="sample-directory-section" aria-labelledby="hardware-documentation">
    <h2 id="hardware-documentation">一　OPT4001YMNEVM 开发者文档重构</h2>
    <ol class="sample-directory-list">
      <li><a href="../../core-projects/hardware/">项目概览</a></li>
      ...
      <li><a href="../../core-projects/hardware/troubleshooting/">故障排查</a></li>
    </ol>
  </section>

  <section class="sample-directory-section" aria-labelledby="mini-program-documentation">
    <h2 id="mini-program-documentation">二　小程序产品文档集</h2>
    <ol class="sample-directory-list">
  ...
  <section class="sample-directory-section" aria-labelledby="docs-quality-pipeline">
    <h2 id="docs-quality-pipeline">三　文档质量检查自动化流水线</h2>
    <ol class="sample-directory-list">
      <li><a href="../../01-automation/">项目概览</a></li>
  ...
  <section class="sample-directory-section" aria-labelledby="other-samples">
    <h2 id="other-samples">五　其他样稿</h2>
    <ol class="sample-directory-list">
  ...
  <p class="sample-directory-back"><a href="../">返回写作样稿</a></p>
</div>
